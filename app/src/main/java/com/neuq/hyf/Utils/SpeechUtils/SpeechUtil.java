...
public class SpeechUtil implements SpeechSynthesizerListener {
    ...
    private static final String APIKEY = "Gc4aanzgEGrAhwh9tyFBIuP4";
    private static final String SECRETKEY = "eYg2TGb5nNem7DyXcpsGDeOyZuVlmB3q";
    private static final String APPID = "10564512";
